...
output_file = video_file_path[:-4] + 'DeepCut_resnetNone_np3_face_camMar30shuffle1_1030000.h5' #face                           #WBW DEBUG TRY THE NEXT LINE HARDCODED
...
path_config_file = '/allen/aibs/technology/waynew/eye/np3_face_cam-sam_corbett-2020-03-30/config_ubuntu.yaml'
...
#deeplabcut.analyze_videos(path_config_file, [video_file_path], save_as_csv=False, videotype='.mp4', gputouse=cudadev, destfolder='/allen/aibs/technology/waynew/allen/programs/braintv/production/visualbehavior/prod0/specimen_1109521187/ecephys_session_1131778697/face_tracking/') #face version 2021
deeplabcut.analyze_videos(path_config_file, [video_file_path], save_as_csv=False, videotype='.mp4', gputouse=cudadev) #face version 2021
